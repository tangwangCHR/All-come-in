...
#define    NFCONF                           _REG(0x4E000000)		//NAND Flash ÅäÖÃ¼Ä´æÆ÷
#define    NFCONT                           _REG(0x4E000004)		//¿ØÖÆ¼Ä´æÆ÷
#define    NFCMMD                           _REG(0x4E000008)		//ÃüÁî¼Ä´æÆ÷
#define    NFADDR                           _REG(0x4E00000c)		//µØÖ·¼Ä´æÆ÷

#define    NFDATA                           _REG_BYTE(0x4E000010)		//Êý¾Ý¼Ä´æÆ÷
#define    NFMECCD0                         _REG(0x4E000014)		//Ö÷Êý¾ÝÇøÓò¼Ä´æÆ÷
#define    NFMECCD1                         _REG(0x4E000018)		//Ö÷Êý¾ÝÇøÓò¼Ä´æÆ÷

#define    NFSECCD                          _REG(0x4E00001c)		//±¸·ÝÇøÓò ECC ¼Ä´æÆ÷
#define    NFSTAT                           _REG(0x4E000020)		//NFCON ×´Ì¬¼Ä´æÆ÷
 
#define    NFESTAT0                         _REG(0x4E000024)		//ECC0/1 ×´Ì¬¼Ä´æÆ÷
#define    NFESTAT1                         _REG(0x4E000028)		//ECC0/1 ×´Ì¬¼Ä´æÆ÷

#define    NFMECC0                         _REG(0x4E00002c)		//Ö÷Êý¾ÝÇøÓò ECC0/1 ×´Ì¬¼Ä´æÆ÷
#define    NFMECC1                         _REG(0x4E000030)		//Ö÷Êý¾ÝÇøÓò ECC0/1 ×´Ì¬¼Ä´æÆ÷


#define    NFSECC                          _REG(0x4E000034)		//±¸·ÝÇøÓò ECC ×´Ì¬¼Ä´æÆ÷


#define    NFSBLK                          _REG(0x4E000038)		//¿éµØÖ·¼Ä´æÆ÷
#define    NFEBLK                          _REG(0x4E00003c)		//¿éµØÖ·¼Ä´æÆ÷
...
#define    LCDCON1                         _REG(0X4D000000)		//LCD ¿ØÖÆÆ÷ÌØÊâ¼Ä´æÆ÷  LCD ¿ØÖÆ 1 ¼Ä´æÆ÷
#define    LCDCON2                         _REG(0X4D000004)		//LCD ¿ØÖÆ 2 ¼Ä´æÆ÷
#define    LCDCON3                         _REG(0X4D000008)		//LCD ¿ØÖÆ 3 ¼Ä´æÆ÷
#define    LCDCON4                         _REG(0X4D00000C)		//LCD ¿ØÖÆ 4 ¼Ä´æÆ÷
#define    LCDCON5                         _REG(0X4D000010)		//LCD ¿ØÖÆ 5 ¼Ä´æÆ÷


#define    LCDSADDR1                       _REG(0X4D000014)		//Ö¡»º³åÆ÷¿ªÊ¼µØÖ· 1 ¼Ä´æÆ÷
#define    LCDSADDR2                       _REG(0X4D000018)		//Ö¡»º³åÆ÷¿ªÊ¼µØÖ· 2 ¼Ä´æÆ÷
#define    LCDSADDR3                       _REG(0X4D00001C)		//Ö¡»º³åÆ÷¿ªÊ¼µØÖ· 3 ¼Ä´æÆ÷

#define    REDLUT                          _REG(0X4D000020)		//ºìÉ«²éÕÒ±í¼Ä´æÆ÷
#define    GREENLUT                        _REG(0X4D000024)		//ÂÌÉ«É«²éÕÒ±í¼Ä´æÆ÷
#define    BLUELUT                         _REG(0X4D000028)		//À¶É«²éÕÒ±í¼Ä´æÆ÷


#define    DITHMODE                         _REG(0X4D00004c)		//¶¶¶¯Ä£Ê½¼Ä´æÆ÷
#define    TPAL                             _REG(0X4D000050)		//ÁÙÊ±µ÷É«°å¼Ä´æÆ÷

#define    LCDINTPND                       _REG(0X4D000054)		//LCD ÖÐ¶Ï¹ÒÆð¼Ä´æÆ÷


#define    LCDSRCPND                       _REG(0X4D000058)		//LCD Ô´¹ÒÆð¼Ä´æÆ÷
#define    LCDINTMSK                       _REG(0X4D00005c)		//LCD ÖÐ¶ÏÆÁ±Î¼Ä´æÆ÷
#define    TCONSEL                         _REG(0X4D000060)		//TCON ¿ØÖÆ¼Ä´æÆ÷
...
#define    ADCCON                         _REG(0x58000000)		//ADC ¿ØÖÆ¼Ä´æÆ÷£¨ADCCON£©
#define    ADCTSC                         _REG(0x58000004)		//ADC ´¥ÃþÆÁ¿ØÖÆ¼Ä´æÆ÷£¨ADCTSC£©
#define    ADCDLY                         _REG(0x58000008)		//ADC Æô¶¯ÑÓÊ±¼Ä´æÆ÷£¨ADCDLY£©
#define    ADCDAT0                        _REG(0x5800000C)		//ADC ×ª»»Êý¾Ý¼Ä´æÆ÷£¨ADCDAT0£©
#define    ADCDAT1                        _REG(0x58000010)		//ADC ×ª»»Êý¾Ý¼Ä´æÆ÷£¨ADCDAT1£©
#define    ADCUPDN                        _REG(0x58000014)		//ADC ´¥ÃþÆÁÆðÂäÖÐ¶Ï¼ì²â¼Ä´æÆ÷£¨ADCUPDN£©
